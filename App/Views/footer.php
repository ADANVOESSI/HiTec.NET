<footer class="footer_container center">
            
            <h2>Moyens de paiement</h2>
            <!-- Trouver une alternative pour la source -->
            <div class="parent flex ">
                <img class="first" width="1" height="1" style="border-radius: 5px">
                <img class="second" width="1" height="1" style="border-radius: 5px">
                <img class="third" width="1" height="1" style="border-radius: 5px">
                <img class="fourth" width="1" height="1" style="border-radius: 5px">
            </div>
